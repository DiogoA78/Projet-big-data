...
#Ucl
df1 = pd.read_csv("dataset/LDC/LDC_games.csv", index_col=0)
df2 = pd.read_csv("dataset/LDC/LDC_group.csv", index_col=0)
#Ucl C
df3 = pd.read_csv("dataset/LDC/ucl_clubs_attack.csv", index_col=0)
df4 = pd.read_csv("dataset/LDC/ucl_clubs_attempt.csv", index_col=0)
df5 = pd.read_csv("dataset/LDC/ucl_clubs_def.csv", index_col=0)
df6 = pd.read_csv("dataset/LDC/ucl_clubs_discip.csv", index_col=0)
df7 = pd.read_csv("dataset/LDC/ucl_clubs_distrib.csv", index_col=0)
df8 = pd.read_csv("dataset/LDC/ucl_clubs_gk.csv", index_col=0)
df9 = pd.read_csv("dataset/LDC/ucl_clubs_goals.csv", index_col=0)
df10 = pd.read_csv("dataset/LDC/ucl_clubs_key.csv", index_col=0)
#Ucl P
df11 = pd.read_csv("dataset/LDC/ucl_players_attack.csv", index_col=0)
df12 = pd.read_csv("dataset/LDC/ucl_players_attempt.csv", index_col=0)
df13 = pd.read_csv("dataset/LDC/ucl_players_def.csv", index_col=0)
df14 = pd.read_csv("dataset/LDC/ucl_players_discip.csv", index_col=0)
df15 = pd.read_csv("dataset/LDC/ucl_players_distrib.csv", index_col=0)
df16 = pd.read_csv("dataset/LDC/ucl_players_gk.csv", index_col=0)
df17 = pd.read_csv("dataset/LDC/ucl_players_goals.csv", index_col=0)
df18 = pd.read_csv("dataset/LDC/ucl_players_key.csv", index_col=0)
#El
df19 = pd.read_csv("dataset/EL/el_games.csv", index_col=0)
df20 = pd.read_csv("dataset/EL/el_group.csv", index_col=0)
#El C
df21 = pd.read_csv("dataset/EL/el_stats_clubs_attack.csv", index_col=0)
df22 = pd.read_csv("dataset/EL/el_stats_clubs_attempts.csv", index_col=0)
df23 = pd.read_csv("dataset/EL/el_stats_clubs_defending.csv", index_col=0)
df24 = pd.read_csv("dataset/EL/el_stats_clubs_discip.csv", index_col=0)
df25 = pd.read_csv("dataset/EL/el_stats_clubs_distribution.csv", index_col=0)
df26 = pd.read_csv("dataset/EL/el_stats_clubs_gk.csv", index_col=0)
df27 = pd.read_csv("dataset/EL/el_stats_clubs_goals.csv", index_col=0)
df28 = pd.read_csv("dataset/EL/el_stats_clubs_key.csv", index_col=0)
#El P
df29 = pd.read_csv("dataset/EL/el_stats_players_attack.csv", index_col=0)
df30 = pd.read_csv("dataset/EL/el_stats_player_goals.csv", index_col=0)
df31 = pd.read_csv("dataset/EL/el_stats_player_key.csv", index_col=0)
df32 = pd.read_csv("dataset/EL/el_stats_players_attempts.csv", index_col=0)
df33 = pd.read_csv("dataset/EL/el_stats_players_defending.csv", index_col=0)
df34 = pd.read_csv("dataset/EL/el_stats_players_discip.csv", index_col=0)
df35 = pd.read_csv("dataset/EL/el_stats_players_distribution.csv", index_col=0)
df36 = pd.read_csv("dataset/EL/el_stats_players_gk.csv", index_col=0)
#Cdm
df37 = pd.read_csv("dataset/CDM/cdm_group.csv", index_col=0)
df38 = pd.read_csv("dataset/CDM/cdm_games.csv", index_col=0)
