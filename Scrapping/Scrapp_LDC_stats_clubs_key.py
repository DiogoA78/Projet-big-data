...
club = browser.find_element_by_xpath('/html/body/div[2]/div/div/div[2]/div[1]/div[1]/div/div/div/pk-carousel/div/div[3]/pk-button/span')
club.click()
time.sleep(2)
...
filepath = Path('C:/Users/diogo/OneDrive/Documents/GitHub/Projet-big-data/dataset/ucl_clubs_key.csv')
