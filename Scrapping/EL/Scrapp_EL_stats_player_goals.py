...
browser.get('https://www.uefa.com/uefaeuropaleague/statistics/players/goals/')
time.sleep(2)
...
df = df.replace({'Ben Yedder': "Ben_Yedder"}, regex=True)


filepath = Path('C:/Users/diogo/OneDrive/Documents/GitHub/Projet-big-data/work/data/EL/el_stats_player_goals.csv')
