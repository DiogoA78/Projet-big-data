...
browser.get("https://www.uefa.com/uefaeuropaleague/statistics/players/attempts/")
time.sleep(2)
...
df = df.replace({'Ricardo Horta': "Ricardo_Horta"}, regex=True)



filepath = Path('C:/Users/diogo/OneDrive/Documents/GitHub/Projet-big-data/work/data/EL/el_stats_players_attempts.csv')
