...
browser.get('https://www.uefa.com/uefachampionsleague/statistics/players/goals/')
time.sleep(2)
...
df = df.replace({'João Mário': "João_Mário"}, regex=True)
...
df = df.replace({'Ferran Torres': "Ferran_Torres"}, regex=True)


filepath = Path('C:/Users/diogo/OneDrive/Documents/GitHub/Projet-big-data/work/data/LDC/ucl_players_goals.csv')
