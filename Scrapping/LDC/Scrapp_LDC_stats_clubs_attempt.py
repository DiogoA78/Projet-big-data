...
browser.get('https://www.uefa.com/uefachampionsleague/statistics/clubs/attempts/')
time.sleep(2)
...
filepath = Path('C:/Users/diogo/OneDrive/Documents/GitHub/Projet-big-data/work/data/LDC/ucl_clubs_attempt.csv')
